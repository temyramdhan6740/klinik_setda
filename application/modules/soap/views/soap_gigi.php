     ...
     <div class="col-md-12">
         <div class="card mb-4">
             ...
             <div class="card-header text-white bg-primary mb-3">
                 <h5 class="card-title text-white">Rekam Medis Rawat Jalan POLI GIGI</h5>
             </div>
             <div class="card-body">
                 <div class="mb-3">
                 ...
                 <input type="hidden" id="poli" value="002">
                 <div class="mb-3">
         ...
         <div class="card mb-4">
             <div class="card-body">
                 ...
                 <div class="mb-3">
                     <div class="row">
                         <div class="col-md-6">
                             <label for="password" class="col-form-label">Odontogram</label>
                             <img class="card-img-top" src="<?= base_url('assets/img/odontogram_gigi.png') ?>"
                                 alt="odontogram">
                         </div>
                         <div class="col-md-6">
                             <div class="row">
                                 <div class="col-md-6">
                                     <label for="password" class="col-form-label">Elemen gigi</label>
                                     <select class="form-select" id="elemen_gigi">
                                 ...
                                 <div class="col-md-2">
                                     ...
                                     <button type="button" class="btn btn-primary" id="btn_tambah_gigi">Tambah</button>
                                 </div>
                             </div>
                             <div class="mb-3">
                                 <table class="table table-striped" id="table_gigi">
                                     <thead>
                                         <tr>
                                             <th>Elemen Gigi</th>
                                             <th>Aksi</th>
