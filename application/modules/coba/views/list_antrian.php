                 ...
                 <div class="nav-align-top mb-4">
                     <ul class="nav nav-tabs nav-fill" role="tablist">
                         <li class="nav-item">
                             <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                 data-bs-target="#navs-pasien-lama" value="pasien_lama" aria-controls="navs-pasien-lama"
                                 aria-selected="true">
                         ...
                         <li class="nav-item">
                             <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                 data-bs-target="#navs-pasien-baru" value="pasien_baru" aria-controls="navs-pasien-baru"
                                 aria-selected="false">
                     ...
                     <div class="tab-content">
                         ...
                         <div class="tab-pane fade" id="navs-pasien-baru" role="tabpanel">
                             <div class="card-body">
                                 ...
                                 <div class="mb-3 row">
                                     <label for="html5-text-input" class="col-md-2 col-form-label">No RM</label>
                                     <div class="col-md-10">
                                         <input class="form-control" type="text" id="no_rm_baru" readonly />
                                     </div>
                                 </div>
                                 <div class="mb-3 row">
                         ...
                         <div class="row">
                             <div class="card-body">
                                 <div class="mb-3 row">
                                     <label for="html5-search-input" class="col-md-2 col-form-label">Poli</label>
                                     <div class="col-md-10">
                                 ...
                                 <div class="mb-3 row">
                                     <label for="html5-search-input" class="col-md-2 col-form-label">Anamnesa(S)</label>
                                     <div class="col-md-10">
