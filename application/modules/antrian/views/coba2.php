    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- pasien lama -->
                <div class="mb-3 row">
                    <label for="html5-text-input" class="col-md-2 col-form-label">NIK</label>
                    <div class="col-md-6">
                ...
                <div class="mb-3 row">
                    <label for="html5-search-input" class="col-md-2 col-form-label">HIS</label>
                    <div class="col-md-10">
                        <input class="form-control" id="his" readonly />
                    </div>
                </div>
            </div>
        </div>
